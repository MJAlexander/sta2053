...
fit3 |> 
  ...
  stat_halfeye() + 
  theme_bw() + 
  labs(title = "Posterior estimates of scores by education level of mother",
       subtitle = "for mothers with IQ = 110")
```
...
y_tilde <- rnorm(n = nrow(res), mean = res$mu, sd = res$sigma)
